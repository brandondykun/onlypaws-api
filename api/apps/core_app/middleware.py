...
def get_maintenance_status():
    ...
    if os.environ.get('MAINTENANCE_MODE', '0') == '1':
        return (
            True,
            os.environ.get('MAINTENANCE_MESSAGE', 'The system is currently undergoing maintenance.'),
...
class MaintenanceModeMiddleware:
    ...
    def __call__(self, request):
        ...
        if is_maintenance and not self._is_excluded_path(request.path):
            ...
            if allow_admin and hasattr(request, 'user') and request.user.is_authenticated:
