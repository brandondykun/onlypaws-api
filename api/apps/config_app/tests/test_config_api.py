...
class PrivateAdsConfigApiTests(TestCase):
    ...
    def test_retrieve_ads_config_success(self):
        ...
        AppConfiguration.objects.create(
            key="ads_config",
            value={"enabled": True, "adInterval": 10},
    ...
    def test_retrieve_ads_config_disabled(self):
        ...
        AppConfiguration.objects.create(
            key="ads_config", value={"enabled": False, "adInterval": 5}
        )
    ...
    def test_retrieve_ads_config_different_interval(self):
        ...
        AppConfiguration.objects.create(
            key="ads_config", value={"enabled": True, "adInterval": 15}
        )
    ...
    def test_retrieve_ads_config_empty_value_returns_defaults(self):
        ...
        AppConfiguration.objects.create(key="ads_config", value={})
    ...
    def test_retrieve_ads_config_zero_interval(self):
        ...
        AppConfiguration.objects.create(
            key="ads_config", value={"enabled": True, "adInterval": 0}
        )
    ...
    def test_retrieve_ads_config_negative_interval_returns_defaults(self):
        ...
        AppConfiguration.objects.create(
            key="ads_config", value={"enabled": True, "adInterval": -5}
        )
    ...
    def test_retrieve_ads_config_large_interval(self):
        ...
        AppConfiguration.objects.create(
            key="ads_config", value={"enabled": True, "adInterval": 999999}
        )
    ...
    def test_retrieve_ads_config_different_user(self):
        ...
        profile2 = create_profile(user=user2, username="testuser2")

        # Create ads config
        AppConfiguration.objects.create(
            key="ads_config", value={"enabled": False, "adInterval": 20}
        )
    ...
    def test_retrieve_ads_config_null_values_returns_defaults(self):
        ...
        AppConfiguration.objects.create(
            key="ads_config", value={"enabled": None, "adInterval": None}
        )
    ...
    def test_multiple_configs_only_ads_config_used(self):
        ...
        AppConfiguration.objects.create(
            key="other_config", value={"enabled": False, "adInterval": 100}
        )
        AppConfiguration.objects.create(
            key="ads_config", value={"enabled": True, "adInterval": 7}
        )
